...
.globl	rsaz_1024_sqr_avx2
.def	rsaz_1024_sqr_avx2;	.scl 2;	.type 32;	.endef
.p2align	6
...
.globl	rsaz_1024_mul_avx2
.def	rsaz_1024_mul_avx2;	.scl 2;	.type 32;	.endef
.p2align	6
...
.def	rsaz_1024_red2norm_avx2;	.scl 2;	.type 32;	.endef
.p2align	5
...
.def	rsaz_1024_norm2red_avx2;	.scl 2;	.type 32;	.endef
.p2align	5
...
.def	rsaz_1024_scatter5_avx2;	.scl 2;	.type 32;	.endef
.p2align	5
...
.def	rsaz_1024_gather5_avx2;	.scl 2;	.type 32;	.endef
.p2align	5
...
.p2align	5
.Loop_gather_1024:
	vpand	-64(%rdx),%xmm8,%xmm0
	vpand	(%rdx),%xmm9,%xmm1
	vpand	64(%rdx),%xmm10,%xmm2
	vpand	(%rdx,%r11,2),%xmm11,%xmm3
	vpor	%xmm0,%xmm1,%xmm1
	vpand	64(%rdx,%r11,2),%xmm12,%xmm4
	vpor	%xmm2,%xmm3,%xmm3
	vpand	(%rdx,%r11,4),%xmm13,%xmm5
	vpor	%xmm1,%xmm3,%xmm3
	vpand	64(%rdx,%r11,4),%xmm14,%xmm6
	vpor	%xmm4,%xmm5,%xmm5
	vpand	-128(%rdx,%r11,8),%xmm15,%xmm2
	leaq	(%rdx,%r11,8),%rdx
	vpor	%xmm3,%xmm5,%xmm5
	vpor	%xmm2,%xmm6,%xmm6
	vpor	%xmm5,%xmm6,%xmm6
...
.globl	rsaz_avx2_eligible
.def	rsaz_avx2_eligible;	.scl 2;	.type 32;	.endef
.p2align	5
